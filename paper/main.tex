...
atom is reached---which we report as measured rather than proved
(Appendix~\ref{app:deferred}).
...
reproduced to six decimal places for $h\in\{0,0.7\}$ and $w\in\{0,3,12\}$). We do not
prove that stronger statement: it requires a trapping argument near $t=1$ that we have
not completed, and we prefer to mark the boundary than to assert past it.
