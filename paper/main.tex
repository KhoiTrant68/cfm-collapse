...
against $h$. And repeating $h{=}0$ and $h{=}4$ at a second seed---which redraws the
mask, the training subset and all training randomness---moves $\tr\Cov$ at $h{=}4$ by
$35\%$ ($178.5\to240.7$) while the ratio to the Theorem~\ref{thm:endpoint} reference
moves by $3.5\%$ ($6.83\to7.07$): the reference-relative quantity is the stable one.
