...
\item \textbf{Separation of two remedies.} Label noise changes the population
  ...
  (Propositions~\ref{prop:prop17} and \ref{prop:factors}). The obstruction in
...
label smoothing. Of the three interventions considered here, only smoothing the
conditioning variable changes the population endpoint at all
(Propositions~\ref{prop:prop17} and~\ref{prop:cfg}), and even that one cannot leave the
training atoms (Proposition~\ref{prop:atomicity}).
