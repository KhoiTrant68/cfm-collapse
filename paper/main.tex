...
to restore conditional diversity.
...
Two further results stay in the appendices and are not claimed here: a loss floor
$d/(3L)$ from a uniform Lipschitz bound, about $50\times$ below the observed plateau
(Corollary~\ref{cor:floor}), and two representability results for a randomly drawn finite
unconditional batch (Appendix~\ref{sec:theory-d2}), which the conditional statements do
not need.
